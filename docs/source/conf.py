...
# -*- coding: utf-8 -*-
#
# ffscraper documentation build configuration file, created by
...
htmlhelp_basename = 'ffscraperdoc'
...
man_pages = [
    (master_doc, 'ffscraper', 'ffscraper Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ffscraper', 'ffscraper Documentation',
     author, 'ffscraper', 'One line description of project.',
     'Miscellaneous'),
]
